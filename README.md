...
After starting, the services will be available at: https://server.localhost (application), https://wordpress.localhost (WordPress) and http://localhost:8080 (Traefik dashboard).

Since the HTTPS certificate is a self-signed dummy certificate generated by Traefik, your browser will show a security warning. Just click "Advanced" and proceed to the site.
